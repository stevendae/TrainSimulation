...
void Files::saveToJson(const std::string& filename, const std::shared_ptr<Track>& track, const std::vector<std::shared_ptr<Train>>& trains){
...
void Files::loadFromJson(const std::string& filename, std::shared_ptr<Track>& track, std::vector<std::shared_ptr<Train>>& trains) {
